...
class MedalDataSet {
    ...
    suspend fun getMedalData() : List<MedalModel> = withContext(Dispatchers.IO) {
        ...
        medalListModelForPersonalRecords.add(MedalListModel(1,"Longest Run","00:00", R.drawable.longest_run,true))
        medalListModelForPersonalRecords.add(MedalListModel(2,"Highest Elevation","2095 ft",R.drawable.highest_elevation,true))
        ...
        medalListModelForVirtualRaces.add(MedalListModel(1,"Virtual Half Marathon","00:00",R.drawable.virtual_half_marathon_race,true))
        medalListModelForVirtualRaces.add(MedalListModel(2,"Tokyo-Hakone Ekiden","00:00:00",R.drawable.tokyo_kakone_ekiden,true))
        medalListModelForVirtualRaces.add(MedalListModel(3,"Virtual 10K Race","00:00:00",R.drawable.virtual_10k_race,true))
        medalListModelForVirtualRaces.add(MedalListModel(4,"Hakone Ekiden","00:00:00",R.drawable.hakone_ekiden,true))
        medalListModelForVirtualRaces.add(MedalListModel(5,"Mizuno Singapore\n" +
                "Ekiden 2015","00:00:00",R.drawable.mizuno_singapore_ekiden,true))
        medalListModelForVirtualRaces.add(MedalListModel(6,"Virtual 5K Race","23:07",R.drawable.virtual_5k_race,true))
